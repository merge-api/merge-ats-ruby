...
# Unit tests for MergeATSClient::ActivitiesApi
...
describe 'ActivitiesApi' do
  ...
  describe 'test an instance of ActivitiesApi' do
    it 'should create an instance of ActivitiesApi' do
      expect(@api_instance).to be_instance_of(MergeATSClient::ActivitiesApi)
    end
  end
  ...
  # unit tests for activities_destroy
  ...
  # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
  # @return [Activity]
  describe 'activities_destroy test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for activities_partial_update
  ...
  # @return [Activity]
  describe 'activities_partial_update test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
