...
describe 'RejectReasonsApi' do
  ...
  # unit tests for reject_reasons_create
  ...
  # @return [RejectReason]
  describe 'reject_reasons_create test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for reject_reasons_destroy
  ...
  # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
  # @return [RejectReason]
  describe 'reject_reasons_destroy test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for reject_reasons_partial_update
  ...
  # @return [RejectReason]
  describe 'reject_reasons_partial_update test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
