...
# Unit tests for MergeATSClient::PatchedCandidate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PatchedCandidate' do
  before do
    # run before each test
    @instance = MergeATSClient::PatchedCandidate.new
  end
  ...
  describe 'test an instance of PatchedCandidate' do
    it 'should create an instance of PatchedCandidate' do
      expect(@instance).to be_instance_of(MergeATSClient::PatchedCandidate)
    end
  end
