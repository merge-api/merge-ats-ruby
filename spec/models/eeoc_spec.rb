...
# Unit tests for MergeATSClient::EEOC
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeATSClient::EEOC do
  let(:instance) { MergeATSClient::EEOC.new }

  describe 'test an instance of EEOC' do
    it 'should create an instance of EEOC' do
      expect(instance).to be_instance_of(MergeATSClient::EEOC)
    end
  end
