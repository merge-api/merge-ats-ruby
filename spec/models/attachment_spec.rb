...
# Unit tests for MergeATSClient::Attachment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeATSClient::Attachment do
  let(:instance) { MergeATSClient::Attachment.new }

  describe 'test an instance of Attachment' do
    it 'should create an instance of Attachment' do
      expect(instance).to be_instance_of(MergeATSClient::Attachment)
    end
  end
