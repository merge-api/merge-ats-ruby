...
# Unit tests for MergeATSClient::MetaResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeATSClient::MetaResponse do
  let(:instance) { MergeATSClient::MetaResponse.new }

  describe 'test an instance of MetaResponse' do
    it 'should create an instance of MetaResponse' do
      expect(instance).to be_instance_of(MergeATSClient::MetaResponse)
    end
  end
