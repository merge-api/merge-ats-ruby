...
opts = {
  application_id: TODO, # String | If provided, will only return interviews for this application.
  ...
  organizer_id: TODO, # String | If provided, will only return interviews organized by this user.
