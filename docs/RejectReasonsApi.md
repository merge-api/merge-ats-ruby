...
[**reject_reasons_destroy**](RejectReasonsApi.md#reject_reasons_destroy) | **DELETE** /reject-reasons/{id} | 
...
> RejectReason reject_reasons_create(opts)
...
opts = {
  ...
  reject_reason: MergeATSClient::RejectReason.new # RejectReason | 
}

begin
  result = api_instance.reject_reasons_create(opts)
  p result
rescue MergeATSClient::ApiError => e
  puts "Exception when calling RejectReasonsApi->reject_reasons_create: #{e}"
end
```
...
## reject_reasons_destroy

> RejectReason reject_reasons_destroy(id, opts)



Deletes a `RejectReason` object with the given `id`.
...
begin
  result = api_instance.reject_reasons_destroy(id, opts)
  p result
rescue MergeATSClient::ApiError => e
  puts "Exception when calling RejectReasonsApi->reject_reasons_destroy: #{e}"
end
```
...
> PaginatedRejectReasonList reject_reasons_list(opts)
...
begin
  result = api_instance.reject_reasons_list(opts)
  p result
rescue MergeATSClient::ApiError => e
  puts "Exception when calling RejectReasonsApi->reject_reasons_list: #{e}"
end
```
...
> RejectReason reject_reasons_partial_update(id, opts)
...
opts = {
  x_account_token: 'x_account_token_example', # String | Token identifying the end user.
  run_async: true, # Boolean | Whether or not third-party updates should be run asynchronously.
  patched_reject_reason: MergeATSClient::PatchedRejectReason.new # PatchedRejectReason | 
}

begin
  result = api_instance.reject_reasons_partial_update(id, opts)
  p result
rescue MergeATSClient::ApiError => e
  puts "Exception when calling RejectReasonsApi->reject_reasons_partial_update: #{e}"
end
```
...
> RejectReason reject_reasons_retrieve(id, opts)
...
begin
  result = api_instance.reject_reasons_retrieve(id, opts)
  p result
rescue MergeATSClient::ApiError => e
  puts "Exception when calling RejectReasonsApi->reject_reasons_retrieve: #{e}"
end
```
