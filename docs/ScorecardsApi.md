...
opts = {
  application_id: TODO, # String | If provided, will only return scorecards for this application.
  ...
  interview_id: TODO, # String | If provided, will only return scorecards for this interview.
  interviewer_id: TODO, # String | If provided, will only return scorecards for this interviewer.
