...
[**activities_destroy**](ActivitiesApi.md#activities_destroy) | **DELETE** /activities/{id} | 
...
> Activity activities_create(opts)
...
opts = {
  ...
  activity: MergeATSClient::Activity.new # Activity | 
}

begin
  result = api_instance.activities_create(opts)
  p result
rescue MergeATSClient::ApiError => e
  puts "Exception when calling ActivitiesApi->activities_create: #{e}"
end
```
...
> Activity activities_destroy(id, opts)



Deletes an `Activity` object with the given `id`.
...
begin
  result = api_instance.activities_destroy(id, opts)
  p result
rescue MergeATSClient::ApiError => e
  puts "Exception when calling ActivitiesApi->activities_destroy: #{e}"
end
```
...
> PaginatedActivityList activities_list(opts)
...
begin
  result = api_instance.activities_list(opts)
  p result
rescue MergeATSClient::ApiError => e
...
> Activity activities_partial_update(id, opts)
...
opts = {
  x_account_token: 'x_account_token_example', # String | Token identifying the end user.
  run_async: true, # Boolean | Whether or not third-party updates should be run asynchronously.
  patched_activity: MergeATSClient::PatchedActivity.new # PatchedActivity | 
}

begin
  result = api_instance.activities_partial_update(id, opts)
  p result
rescue MergeATSClient::ApiError => e
  puts "Exception when calling ActivitiesApi->activities_partial_update: #{e}"
end
```
...
> Activity activities_retrieve(id, opts)
...
begin
  result = api_instance.activities_retrieve(id, opts)
  p result
rescue MergeATSClient::ApiError => e
