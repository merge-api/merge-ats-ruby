...
> Application applications_create(opts)
...
opts = {
  ...
  application: MergeATSClient::Application.new # Application | 
}

begin
  result = api_instance.applications_create(opts)
  p result
rescue MergeATSClient::ApiError => e
  puts "Exception when calling ApplicationsApi->applications_create: #{e}"
end
```
...
> Application applications_destroy(id, opts)
...
begin
  result = api_instance.applications_destroy(id, opts)
  p result
rescue MergeATSClient::ApiError => e
  puts "Exception when calling ApplicationsApi->applications_destroy: #{e}"
end
```
...
> Application applications_partial_update(id, opts)
...
opts = {
  x_account_token: 'x_account_token_example', # String | Token identifying the end user.
  run_async: true, # Boolean | Whether or not third-party updates should be run asynchronously.
  patched_application: MergeATSClient::PatchedApplication.new # PatchedApplication | 
}

begin
  result = api_instance.applications_partial_update(id, opts)
  p result
rescue MergeATSClient::ApiError => e
  puts "Exception when calling ApplicationsApi->applications_partial_update: #{e}"
end
```
