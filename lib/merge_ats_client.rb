...
require 'merge_ats_client/models/patched_activity'
require 'merge_ats_client/models/patched_application'
require 'merge_ats_client/models/patched_attachment'
require 'merge_ats_client/models/patched_candidate'
require 'merge_ats_client/models/patched_department'
require 'merge_ats_client/models/patched_eeoc'
require 'merge_ats_client/models/patched_email_address'
require 'merge_ats_client/models/patched_job'
require 'merge_ats_client/models/patched_job_interview_stage'
require 'merge_ats_client/models/patched_offer'
require 'merge_ats_client/models/patched_office'
require 'merge_ats_client/models/patched_phone_number'
require 'merge_ats_client/models/patched_reject_reason'
require 'merge_ats_client/models/patched_remote_user'
require 'merge_ats_client/models/patched_scheduled_interview'
require 'merge_ats_client/models/patched_scorecard'
require 'merge_ats_client/models/patched_tag'
require 'merge_ats_client/models/patched_url'
