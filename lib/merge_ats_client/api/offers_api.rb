...
module MergeATSClient
  class OffersApi
    ...
    # @option opts [Offer] :offer 
    # @return [Offer]
    def offers_create(opts = {})
      data, _status_code, _headers = offers_create_with_http_info(opts)
      data
    end
    ...
    def offers_create_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'offer']) 
    ...
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @return [Offer]
    def offers_destroy(id, opts = {})
      data, _status_code, _headers = offers_destroy_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @return [Array<(Offer, Integer, Hash)>] Offer data, response status code and response headers
    def offers_destroy_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OffersApi.offers_destroy ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OffersApi.offers_destroy"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OffersApi#offers_destroy\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :x_account_token Token identifying the end user.
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @option opts [PatchedOffer] :patched_offer 
    # @return [Offer]
    def offers_partial_update(id, opts = {})
      data, _status_code, _headers = offers_partial_update_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [PatchedOffer] :patched_offer 
    # @return [Array<(Offer, Integer, Hash)>] Offer data, response status code and response headers
    def offers_partial_update_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OffersApi.offers_partial_update ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OffersApi.offers_partial_update"
      end
      # resource path
      local_var_path = '/offers/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'patched_offer']) 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OffersApi#offers_partial_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
