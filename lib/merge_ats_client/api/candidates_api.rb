...
module MergeATSClient
  class CandidatesApi
    ...
    # @return [Candidate]
    def candidates_create(x_account_token, opts = {})
      data, _status_code, _headers = candidates_create_with_http_info(x_account_token, opts)
      data
    end
    ...
    def candidates_create_with_http_info(x_account_token, opts = {})
