...
module MergeATSClient
  class ScorecardsApi
    ...
    # @return [Scorecard]
    def scorecards_create(opts = {})
      data, _status_code, _headers = scorecards_create_with_http_info(opts)
      data
    end
    ...
    def scorecards_create_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'scorecard']) 

      # return_type
      return_type = opts[:return_type] || 'Scorecard' 
    ...
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @return [Scorecard]
    def scorecards_destroy(id, opts = {})
      data, _status_code, _headers = scorecards_destroy_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @return [Array<(Scorecard, Integer, Hash)>] Scorecard data, response status code and response headers
    def scorecards_destroy_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ScorecardsApi.scorecards_destroy ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ScorecardsApi.scorecards_destroy"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ScorecardsApi#scorecards_destroy\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def scorecards_list(opts = {})
      data, _status_code, _headers = scorecards_list_with_http_info(opts)
      data
    end
    ...
    def scorecards_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ScorecardsApi.scorecards_list ...'
      end
      allowable_values = ["application", "interview", "interviewer"]
      ...
      # return_type
      return_type = opts[:return_type] || 'PaginatedScorecardList' 
    ...
    # @return [Scorecard]
    def scorecards_partial_update(id, opts = {})
      data, _status_code, _headers = scorecards_partial_update_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [PatchedScorecard] :patched_scorecard 
    # @return [Array<(Scorecard, Integer, Hash)>] Scorecard data, response status code and response headers
    def scorecards_partial_update_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ScorecardsApi.scorecards_partial_update ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ScorecardsApi.scorecards_partial_update"
      end
      # resource path
      local_var_path = '/scorecards/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'patched_scorecard']) 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ScorecardsApi#scorecards_partial_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :expand Which relations should be returned in expanded form.
    # @return [Scorecard]
    def scorecards_retrieve(id, opts = {})
      data, _status_code, _headers = scorecards_retrieve_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :expand Which relations should be returned in expanded form.
    # @return [Array<(Scorecard, Integer, Hash)>] Scorecard data, response status code and response headers
    def scorecards_retrieve_with_http_info(id, opts = {})
      if @api_client.config.debugging
