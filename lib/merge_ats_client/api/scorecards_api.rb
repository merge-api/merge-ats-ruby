...
module MergeATSClient
  class ScorecardsApi
    ...
    # @return [Scorecard]
    def scorecards_create(x_account_token, opts = {})
      data, _status_code, _headers = scorecards_create_with_http_info(x_account_token, opts)
      data
    end
    ...
    def scorecards_create_with_http_info(x_account_token, opts = {})
