...
module MergeATSClient
  class ApplicationsApi
    ...
    # @return [Application]
    def applications_create(x_account_token, opts = {})
      data, _status_code, _headers = applications_create_with_http_info(x_account_token, opts)
      data
    end
    ...
    def applications_create_with_http_info(x_account_token, opts = {})
