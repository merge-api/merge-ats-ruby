...
module MergeATSClient
  class ApplicationsApi
    ...
    # @return [Application]
    def applications_create(opts = {})
      data, _status_code, _headers = applications_create_with_http_info(opts)
      data
    end
    ...
    def applications_create_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'application']) 
    ...
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @return [Application]
    def applications_destroy(id, opts = {})
      data, _status_code, _headers = applications_destroy_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @return [Array<(Application, Integer, Hash)>] Application data, response status code and response headers
    def applications_destroy_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ApplicationsApi.applications_destroy ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ApplicationsApi.applications_destroy"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ApplicationsApi#applications_destroy\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def applications_list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'PaginatedApplicationList' 
    ...
    # @return [Application]
    def applications_partial_update(id, opts = {})
      data, _status_code, _headers = applications_partial_update_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [PatchedApplication] :patched_application 
    # @return [Array<(Application, Integer, Hash)>] Application data, response status code and response headers
    def applications_partial_update_with_http_info(id, opts = {})
      if @api_client.config.debugging
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'patched_application']) 
