...
module MergeATSClient
  class InterviewsApi
    ...
    def interviews_create(x_account_token, opts = {})
      data, _status_code, _headers = interviews_create_with_http_info(x_account_token, opts)
      data
    end
    ...
    def interviews_create_with_http_info(x_account_token, opts = {})
