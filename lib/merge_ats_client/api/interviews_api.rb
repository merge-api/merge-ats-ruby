...
module MergeATSClient
  class InterviewsApi
    ...
    def interviews_create(opts = {})
      data, _status_code, _headers = interviews_create_with_http_info(opts)
      data
    end
    ...
    def interviews_create_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'scheduled_interview']) 
    ...
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @return [ScheduledInterview]
    def interviews_destroy(id, opts = {})
      data, _status_code, _headers = interviews_destroy_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @return [Array<(ScheduledInterview, Integer, Hash)>] ScheduledInterview data, response status code and response headers
    def interviews_destroy_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InterviewsApi.interviews_destroy ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling InterviewsApi.interviews_destroy"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InterviewsApi#interviews_destroy\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def interviews_list(opts = {})
      data, _status_code, _headers = interviews_list_with_http_info(opts)
      data
    end
    ...
    def interviews_list_with_http_info(opts = {})
      if @api_client.config.debugging
    ...
    # @return [ScheduledInterview]
    def interviews_partial_update(id, opts = {})
      data, _status_code, _headers = interviews_partial_update_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [PatchedScheduledInterview] :patched_scheduled_interview 
    # @return [Array<(ScheduledInterview, Integer, Hash)>] ScheduledInterview data, response status code and response headers
    def interviews_partial_update_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InterviewsApi.interviews_partial_update ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling InterviewsApi.interviews_partial_update"
      end
      # resource path
      local_var_path = '/interviews/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'patched_scheduled_interview']) 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InterviewsApi#interviews_partial_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :expand Which relations should be returned in expanded form.
    # @return [ScheduledInterview]
    def interviews_retrieve(id, opts = {})
      data, _status_code, _headers = interviews_retrieve_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :expand Which relations should be returned in expanded form.
    # @return [Array<(ScheduledInterview, Integer, Hash)>] ScheduledInterview data, response status code and response headers
    def interviews_retrieve_with_http_info(id, opts = {})
      if @api_client.config.debugging
