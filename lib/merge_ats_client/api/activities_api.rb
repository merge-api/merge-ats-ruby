...
module MergeATSClient
  class ActivitiesApi
    ...
    # @option opts [Activity] :activity 
    # @return [Activity]
    def activities_create(opts = {})
      data, _status_code, _headers = activities_create_with_http_info(opts)
      data
    end
    ...
    def activities_create_with_http_info(opts = {})
    ...
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @return [Activity]
    def activities_destroy(id, opts = {})
      data, _status_code, _headers = activities_destroy_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @return [Array<(Activity, Integer, Hash)>] Activity data, response status code and response headers
    def activities_destroy_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ActivitiesApi.activities_destroy ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ActivitiesApi.activities_destroy"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ActivitiesApi#activities_destroy\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def activities_list(opts = {})
      data, _status_code, _headers = activities_list_with_http_info(opts)
      data
    end
    ...
    def activities_list_with_http_info(opts = {})
      if @api_client.config.debugging
      ...
      # return_type
      return_type = opts[:return_type] || 'PaginatedActivityList' 
    ...
    # @option opts [String] :x_account_token Token identifying the end user.
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @option opts [PatchedActivity] :patched_activity 
    # @return [Activity]
    def activities_partial_update(id, opts = {})
      data, _status_code, _headers = activities_partial_update_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [PatchedActivity] :patched_activity 
    # @return [Array<(Activity, Integer, Hash)>] Activity data, response status code and response headers
    def activities_partial_update_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ActivitiesApi.activities_partial_update ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ActivitiesApi.activities_partial_update"
      end
      # resource path
      local_var_path = '/activities/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'patched_activity']) 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ActivitiesApi#activities_partial_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :expand Which relations should be returned in expanded form.
    # @return [Activity]
    def activities_retrieve(id, opts = {})
      data, _status_code, _headers = activities_retrieve_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :expand Which relations should be returned in expanded form.
    # @return [Array<(Activity, Integer, Hash)>] Activity data, response status code and response headers
    def activities_retrieve_with_http_info(id, opts = {})
      if @api_client.config.debugging
