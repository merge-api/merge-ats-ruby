...
module MergeATSClient
  class JobInterviewStagesApi
    ...
    def job_interview_stages_create(opts = {})
      data, _status_code, _headers = job_interview_stages_create_with_http_info(opts)
      data
    end
    ...
    def job_interview_stages_create_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: JobInterviewStagesApi.job_interview_stages_create ...'
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'job_interview_stage']) 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: JobInterviewStagesApi#job_interview_stages_create\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @return [JobInterviewStage]
    def job_interview_stages_destroy(id, opts = {})
      data, _status_code, _headers = job_interview_stages_destroy_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @return [Array<(JobInterviewStage, Integer, Hash)>] JobInterviewStage data, response status code and response headers
    def job_interview_stages_destroy_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: JobInterviewStagesApi.job_interview_stages_destroy ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling JobInterviewStagesApi.job_interview_stages_destroy"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: JobInterviewStagesApi#job_interview_stages_destroy\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def job_interview_stages_list(opts = {})
      data, _status_code, _headers = job_interview_stages_list_with_http_info(opts)
      data
    end
    ...
    # @return [JobInterviewStage]
    def job_interview_stages_partial_update(id, opts = {})
      data, _status_code, _headers = job_interview_stages_partial_update_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [PatchedJobInterviewStage] :patched_job_interview_stage 
    # @return [Array<(JobInterviewStage, Integer, Hash)>] JobInterviewStage data, response status code and response headers
    def job_interview_stages_partial_update_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: JobInterviewStagesApi.job_interview_stages_partial_update ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling JobInterviewStagesApi.job_interview_stages_partial_update"
      end
      # resource path
      local_var_path = '/job-interview-stages/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'patched_job_interview_stage']) 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: JobInterviewStagesApi#job_interview_stages_partial_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :expand Which relations should be returned in expanded form.
    # @return [JobInterviewStage]
    def job_interview_stages_retrieve(id, opts = {})
      data, _status_code, _headers = job_interview_stages_retrieve_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :expand Which relations should be returned in expanded form.
    # @return [Array<(JobInterviewStage, Integer, Hash)>] JobInterviewStage data, response status code and response headers
    def job_interview_stages_retrieve_with_http_info(id, opts = {})
      if @api_client.config.debugging
