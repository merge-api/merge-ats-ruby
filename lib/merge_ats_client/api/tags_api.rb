...
module MergeATSClient
  class TagsApi
    ...
    def tags_list(opts = {})
      data, _status_code, _headers = tags_list_with_http_info(opts)
      data
    end
    ...
    def tags_list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'PaginatedTagList' 
    ...
    # @option opts [String] :x_account_token Token identifying the end user.
    # @return [Tag]
    def tags_retrieve(id, opts = {})
      data, _status_code, _headers = tags_retrieve_with_http_info(id, opts)
      data
    end
    ...
    def tags_retrieve_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TagsApi.tags_retrieve ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TagsApi.tags_retrieve"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TagsApi#tags_retrieve\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
