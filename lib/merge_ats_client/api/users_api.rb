...
module MergeATSClient
  class UsersApi
    ...
    # @return [RemoteUser]
    def users_create(x_account_token, opts = {})
      data, _status_code, _headers = users_create_with_http_info(x_account_token, opts)
      data
    end
    ...
    def users_create_with_http_info(x_account_token, opts = {})
