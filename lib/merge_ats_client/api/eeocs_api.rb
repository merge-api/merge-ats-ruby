  ...
  class EeocsApi
    ...
    def eeocs_list_with_http_info(x_account_token, opts = {})
      ...
      if @api_client.config.client_side_validation && x_account_token.nil?
        fail ArgumentError, "Missing the required parameter 'x_account_token' when calling EeocsApi.eeocs_list"
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginatedEEOCList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['tokenAuth']

      new_options = opts.merge(
        :operation => :"EeocsApi.eeocs_list",
    ...
    def eeocs_retrieve_with_http_info(x_account_token, id, opts = {})
      ...
      # verify the required parameter 'x_account_token' is set
      if @api_client.config.client_side_validation && x_account_token.nil?
        fail ArgumentError, "Missing the required parameter 'x_account_token' when calling EeocsApi.eeocs_retrieve"
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EEOC'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['tokenAuth']

      new_options = opts.merge(
        :operation => :"EeocsApi.eeocs_retrieve",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
