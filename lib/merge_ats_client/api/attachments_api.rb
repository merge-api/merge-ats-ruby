...
module MergeATSClient
  class AttachmentsApi
    ...
    # @option opts [String] :remote_user_id The ID of the RemoteUser modifying the resource. This can be found in the ID field (not remote_id) in the RemoteUser table.
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @option opts [AttachmentRequest] :attachment_request 
    # @return [Attachment]
    def attachments_create(x_account_token, opts = {})
      data, _status_code, _headers = attachments_create_with_http_info(x_account_token, opts)
      data
    end
    ...
    def attachments_create_with_http_info(x_account_token, opts = {})
      ...
      query_params[:'remote_user_id'] = opts[:'remote_user_id'] if !opts[:'remote_user_id'].nil?
