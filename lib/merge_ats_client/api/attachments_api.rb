...
module MergeATSClient
  class AttachmentsApi
    ...
    # @return [Attachment]
    def attachments_create(opts = {})
      data, _status_code, _headers = attachments_create_with_http_info(opts)
      data
    end
    ...
    def attachments_create_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'attachment']) 
    ...
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @return [Attachment]
    def attachments_destroy(id, opts = {})
      data, _status_code, _headers = attachments_destroy_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @return [Array<(Attachment, Integer, Hash)>] Attachment data, response status code and response headers
    def attachments_destroy_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AttachmentsApi.attachments_destroy ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AttachmentsApi.attachments_destroy"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AttachmentsApi#attachments_destroy\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def attachments_list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'PaginatedAttachmentList' 
    ...
    # @return [Attachment]
    def attachments_partial_update(id, opts = {})
      data, _status_code, _headers = attachments_partial_update_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [PatchedAttachment] :patched_attachment 
    # @return [Array<(Attachment, Integer, Hash)>] Attachment data, response status code and response headers
    def attachments_partial_update_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AttachmentsApi.attachments_partial_update ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AttachmentsApi.attachments_partial_update"
      end
      # resource path
      local_var_path = '/attachments/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'patched_attachment']) 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AttachmentsApi#attachments_partial_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
